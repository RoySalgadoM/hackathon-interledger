            ...
            <div class="w-full px-4 md:px-0">
              ...
              <form @submit.prevent="handleSubmit" class="w-full" novalidate>
                <div class="space-y-6">
                  ...
                  />
                  <!-- Error Message -->
                  <div v-if="errorMessage" class="text-red-600 p-3">
                    {{ errorMessage }}
                  </div>
                  <EBtn
                    variant="primary"
                    :loading="isLoading"
                    class="w-full h-12 mt-6 font-medium shadow-lg transition-all rounded-lg duration-300 text-black bg-neutral-white hover:bg-primary-2"
                    type="submit"
                  >
              ...
              <div class="flex justify-center w-full py-4">
                <router-link
                  ...
                  class="text-sm text-white hover:text-secondary"
                >
...
<style>
.e-input__login__username .e-input__label__container--transition {
  background-color: transparent;
}
.e-input__login__password .e-input__label__container--transition {
  background-color: transparent;
}
</style>
